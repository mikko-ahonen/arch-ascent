...
from scope.components.scope_graph.scope_graph import ScopeGraph

urlpatterns = []

# Register component URLs
for component_class in [Counter, Search, Quote, ItemsList, DependencyGraph, RefactoringBacklog, FilterPanel, ScopeGraph]:
